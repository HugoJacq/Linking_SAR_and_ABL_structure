...
ALLOCATE(TDUMMY12(IIU,IJU,IKU,4)); TDUMMY12 = 1.0 ! 4 is for the 3 CS tracers, Hugo Jacquet
ALLOCATE(TDUMMY13(IIU,IJU,IKU,4)); TDUMMY13 = 1.0 
ALLOCATE(TDUMMY14(IIU,IJU,IKU,4)); TDUMMY14 = 1.0
ALLOCATE(TDUMMY15(IIU,IJU,IKU,4)); TDUMMY15 = 1.0
ALLOCATE(TDUMMY16(IIU,IJU,IKU,4)); TDUMMY16 = 1.0
ALLOCATE(TDUMMY17(IIU,IJU,IKU,4)); TDUMMY17 = 1.0 
ALLOCATE(TDUMMY18(IIU,IJU,IKU)); TDUMMY18 = 1.0
ALLOCATE(TDUMMY19(IIU,IJU,IKU)); TDUMMY19 = 1.0
ALLOCATE(TDUMMY20(IIU,IJU,IKU)); TDUMMY20 = 1.0
ALLOCATE(TDUMMY21(IIU,IJU,IKU)); TDUMMY21 = 1.0
!
IF (LMEAN_FIELD) THEN
!
  MEAN_COUNT = 0
...
IF (CSURF=='EXTE' .AND. (CPROGRAM=='MESONH' .OR. CPROGRAM=='DIAG  ')) THEN
  ...
  IF (NVERB .GE. 5) WRITE(ILUOUT,FMT=*) 'SFX-OASIS: READ NAM_SFX_SEA_CPL OK'
#endif
