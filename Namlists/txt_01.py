def return_txt_01(UNIFORM_SST,IDEALIZED,FUNC,DIR,T0,deltaT,atpos,Lx,
...
"""
    if UNIFORM_SST:
        string_except = """
    raise Exception("You have chosen a uniform SST no you don't need to run this step! Aborting ...")"""
    else:
        string_except = ''
...
plt.show()
    ...
    TXT_01_replaceSST = part1_replacesst + string_except + center1_replacesst + part2_replacesst + part3_replacesst + part4_replacesst
    ...
    return TXT_01_replaceSST,TXT_01_run